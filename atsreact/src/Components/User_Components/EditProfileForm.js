...
const EditProfileForm = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserDetails = async () => {
            try {
                const response = await axios.get(`https://ats-project-1.onrender.com/auth/user/${userId}`);
                setUserDetails({
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.put(`https://ats-project-1.onrender.com/auth/user/${userId}`, userDetails, {
    ...
    const handlePasswordChange = async (e) => {
        ...
        try {
            const response = await axios.post('https://ats-project-1.onrender.com/auth/change-password', {
                userId,
                currentPassword,
                newPassword,
            }, {
