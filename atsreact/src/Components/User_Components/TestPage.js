...
const TestPage = () => {
  ...
  useEffect(() => {
    const fetchTest = async () => {
      try {
        const response = await axios.get(`https://ats-project.onrender.com/api/tests/category/${category}`, {
          headers: {
    ...
    const checkTestAttempt = async () => {
      ...
      try {
        const response = await axios.get(`https://ats-project.onrender.com/api/tests/check-attempt/${applicationId}`, {
          headers: {
            Authorization: `Bearer ${authToken}`,
          }
        });
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      const response = await axios.post(
        'https://ats-project.onrender.com/api/tests/submit',
        payload,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
