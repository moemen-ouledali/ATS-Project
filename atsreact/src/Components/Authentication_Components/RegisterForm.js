...
const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://ats-project.onrender.com/auth/register', userData);
  ...
  const handleVerifyCode = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://ats-project.onrender.com/auth/verify-code', { email: userData.email, code: verificationCode });
      setMessage(response.data.message);
