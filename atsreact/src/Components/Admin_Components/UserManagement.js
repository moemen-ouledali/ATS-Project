...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Define a custom theme using Material-UI's createTheme
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const StyledCard = styled(Card)({
  ...
  '&:hover': {
    ...
    boxShadow: '0 20px 40px rgba(0,0,0,0.1)', // Add shadow on hover
  },
  borderRadius: '15px',
  overflow: 'hidden',
  position: 'relative',
...
const UserManagement = () => {
  ...
  const [searchTermManager, setSearchTermManager] = useState(''); // Search term for managers
  const [searchTermCandidate, setSearchTermCandidate] = useState(''); // Search term for candidates
  const [searchTermAdmin, setSearchTermAdmin] = useState(''); // Search term for admins
  const [selectedUser, setSelectedUser] = useState(null); // Selected user for role change
  const [newRole, setNewRole] = useState(''); // New role for the selected user
  const [modalOpen, setModalOpen] = useState(false); // Modal open state
  const [view, setView] = useState('manageUsers'); // Current view state
  ...
  // State for new manager details
  const [currentPage, setCurrentPage] = useState(1); // Current page for pagination
  const usersPerPage = 10; // Users per page for pagination
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // Render the user table based on role
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
