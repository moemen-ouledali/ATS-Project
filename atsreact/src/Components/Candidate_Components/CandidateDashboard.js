...
const CandidateDashboard = () => {
  ...
  const fetchApplications = useCallback(async () => {
    setLoading(true);
    try {
      const response = await axios.get('https://ats-project.onrender.com/api/applications', {
        headers: {
          ...
          <Box sx={{
            ...
            {selectedApplication && (
              <>
                ...
                <Typography variant="body2" gutterBottom>
                  <strong>Resume:</strong> <a href={`https://ats-project.onrender.com/${selectedApplication.resumePath}`} target="_blank" rel="noopener noreferrer">View Resume</a>
                </Typography>
                <Typography variant="body2" gutterBottom>
