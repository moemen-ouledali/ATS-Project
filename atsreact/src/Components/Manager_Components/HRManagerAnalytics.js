  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [
        ...
        axios.get('https://ats-project-1.onrender.com/api/analytics/application-status', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/applications-over-time', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/education-level', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/experience-level', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/applications-per-category', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/test-scores', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/top-universities', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/applicants-by-city', { params }),
        axios.get('https://ats-project-1.onrender.com/api/analytics/gender', { params }),
      ]);
